import { Controller, Get, Put, Post, Delete, Body, Param, UseGuards, HttpCode } from '@nestjs/common';
...
export class MemberController {
  ...
  async getMyProfile(@CurrentUser() user: AuthenticatedUser): Promise<MemberRelationshipsResponseDto> {
